...
<pre><code class="language-bash">npm pkg get contributors.emailDTO
</code></pre>
...
<pre><code class="language-bash">npm pkg get contributors[0].emailDTO
</code></pre>
...
contributor entry:</p>
<pre><code class="language-bash">npm pkg set contributors[0].name='Foo' contributors[0].emailDTO='foo@bar.ca'
</code></pre>
