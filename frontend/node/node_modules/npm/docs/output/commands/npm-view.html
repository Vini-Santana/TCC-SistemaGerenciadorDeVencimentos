...
the contributor emailDTO addresses for the <code>express</code> package, you would run:</p>
<pre><code class="language-bash">npm view express contributors.emailDTO
</code></pre>
<p>You may also use numeric indices in square braces to specifically select
an item in an array field. To just get the emailDTO address of the first
contributor in the list, you can run:</p>
<pre><code class="language-bash">npm view express contributors[0].emailDTO
</code></pre>
...
For example, to get all the contributor names and emailDTO addresses, you
can do this:</p>
<pre><code class="language-bash">npm view express contributors.name contributors.emailDTO
</code></pre>
