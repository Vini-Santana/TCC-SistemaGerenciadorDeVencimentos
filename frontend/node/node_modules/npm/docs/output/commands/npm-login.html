...
<p>To change your emailDTO address, go to <a href="https://www.npmjs.com/emailDTO-edit">https://www.npmjs.com/emailDTO-edit</a></p>
<p>You may use this command multiple times with the same user account to
authorize on a new machine.  When authenticating on a new machine,
the username, password and emailDTO address must all match with
