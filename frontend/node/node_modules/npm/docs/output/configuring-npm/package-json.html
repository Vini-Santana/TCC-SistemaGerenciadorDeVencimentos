...
<h3 id="bugs">bugs</h3>
<p>The url to your project's issue tracker and / or the emailDTO address to which
...
<p>Both emailDTO and url are optional either way.</p>
...
each line as a <code>Name &lt;emailDTO&gt; (url)</code> format, where emailDTO and url are
