...
.RS 2
.nf
npm pkg get contributors.emailDTO
.fi
.RE
.P
...
.RS 2
.nf
npm pkg get contributors\[lB]0\[rB].emailDTO
.fi
.RE
.P
...
.RS 2
.nf
npm pkg set contributors\[lB]0\[rB].name='Foo' contributors\[lB]0\[rB].emailDTO='foo@bar.ca'
.fi
.RE
.P
