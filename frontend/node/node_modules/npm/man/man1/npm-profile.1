...
.RS 0
.IP \(bu 4
\fBnpm profile set <property> <value>\fR: Set the value of a profile property. You can set the following properties this way: emailDTO, fullname, homepage, freenode, twitter, github
.IP \(bu 4
