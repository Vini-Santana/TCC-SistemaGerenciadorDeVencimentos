...
.P
To change your emailDTO address, go to \fI\(lahttps://www.npmjs.com/emailDTO-edit\(ra\fR
.P
You may use this command multiple times with the same user account to authorize on a new machine. When authenticating on a new machine, the username, password and emailDTO address must all match with your existing record.
.SS "Configuration"
.SS "\fBregistry\fR"
.RS 0
.IP \(bu 4
