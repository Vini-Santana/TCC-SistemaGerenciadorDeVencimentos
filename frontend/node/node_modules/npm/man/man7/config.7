...
.P
The value \fBnpm init\fR should use by default for the package author's emailDTO.
...
Type: String
.IP \(bu 4
DEPRECATED: Use \fB--init-author-emailDTO\fR instead.
.RE 0

.P
Alias for \fB--init-author-emailDTO\fR
.SS "\fBinit.author.name\fR"
.RS 0
.IP \(bu 4
Default: ""
