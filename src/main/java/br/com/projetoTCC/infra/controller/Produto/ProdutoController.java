...
public class ProdutoController {
    ...
    public ResponseEntity<ProdutoDTO> cadastrarProduto(@RequestBody@Valid ProdutoDTO dto){
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body(new ProdutoDTO(produtoSalvo.getNomeProduto(), produtoSalvo.getCodigo(), produtoSalvo.getQuantidade(), produtoSalvo.getValidade(), produtoSalvo.getObservacoes()));
    }
